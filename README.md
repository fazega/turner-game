...
The fish stalls use Microsoft’s CC0 Barramundi Fish model from the Khronos glTF sample collection, with its authored geometry, colour, normal and metallic/roughness textures. The optimized local GLB is approximately 1 MB and shared by all market fish. Cargo has shipping labels and metal fasteners; barrels have rivets; sacks have stitched seams; rope and fruit use additional surface detail. Market counters include cutting boards, knives and salt bowls. These details are generated locally and use shared materials and static batching.
