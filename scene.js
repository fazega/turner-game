import {preloadFruit} from './fruit-models.js';
...
const [assets,characters]=await Promise.all([loadModelLibrary(),loadCharacters(),preloadPBR(),preloadFoliage(),preloadFish(),preloadFruit()]);
